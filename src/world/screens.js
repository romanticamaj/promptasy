...
export const SCREEN_BANDS = Object.freeze([
   ...
   *
   * `screen-fit` 掃過 4,920 個格點 × 24 個角度：擋在視線上的擺法有 7,877 種，
   * 其中 9 種通過每一條淨空，重建驗過 1 種 —— 就是這一個。
   */
  {
   ...
   * 擋在視線上又離橋頭夠遠的擺法有 41,747 種，全部踩到別人的淨空，只有這一小塊活下來
   * （8 個候選全擠在 ±1 公尺內）。量到的揭露是**前 12 公尺看不到、第 12 公尺揭露**
